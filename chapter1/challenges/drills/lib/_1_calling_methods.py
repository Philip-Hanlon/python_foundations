...
def float_is_positive(float):
    if float > 0:
        return("The float is positive.")
    else:
        return("The float is not positive.")
print (float_is_positive(1))    
...
def float_is_negative(float):
    if float < 0:
        return("The float is negative.")
    else:
        return("The float is not negaitive.")
print (float_is_negative(1))    
